...
def test_legacy_pair_refinement_enforces_non_overlap_and_fiber_union():
...
def test_legacy_pair_refinement_flags_orphans_and_g_ratio_outliers():
...
def test_legacy_pair_refinement_accepts_candidate_mask_objects_and_uses_best_channel():
    bad = torch.zeros(4, 4)
